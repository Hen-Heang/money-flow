      ...
      {keys.map((key) => {
        ...
        return (
          <motion.button
            ...
            className={`h-14 sm:h-16 flex items-center justify-center rounded-2xl text-xl font-bold transition-colors ${
              isOperator 
                ? isDelete ? 'text-red-400 bg-red-400/5' : 'text-[var(--color-accent-base)] bg-[var(--color-accent-base)]/5'
