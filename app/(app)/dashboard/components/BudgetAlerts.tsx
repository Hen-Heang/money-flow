  ...
  return (
    <AnimatePresence>
      <motion.div 
        ...
        className={`rounded-[28px] border p-6 shadow-2xl overflow-hidden relative group transition-all duration-500 ${
          isCritical 
      ...
      >
        <div className="flex items-center justify-between mb-5">
          <div className="flex items-center gap-3">
            ...
            <span className={`text-tiny font-black tracking-[0.2em] ${isCritical ? 'text-red-400' : 'text-amber-400'}`}>
          ...
          {alerts.map(alert => (
            ...
            >
              <div className="flex justify-between mb-2.5">
                ...
                <span className={`text-tiny font-black ${alert.over ? 'text-red-400' : 'text-amber-400'}`}>
                  {alert.pct}% Used
                </span>
              </div>
