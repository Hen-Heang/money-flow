  ...
  return (
    ...
    >
      <div className="p-6 flex items-center justify-between border-b border-white/5 bg-white/[0.01]">
        <h3 className="text-tiny font-black opacity-40 tracking-[0.2em]">Recent Activity</h3>
        <button 
      ...
      <div className="divide-y divide-white/5">
        {transactions.slice(0, limit).map((t, i) => (
          ...
          >
            <div className={`w-12 h-12 rounded-[18px] flex items-center justify-center text-2xl shadow-inner transition-transform group-hover:scale-110 shrink-0 ${
              t.type === 'income' 
            ...
            <div className="flex-1 min-w-0">
              <p className="font-bold text-[15px] truncate tracking-tight text-white/90">{t.description}</p>
              <p className="text-tiny text-[var(--color-text-secondary)] font-bold opacity-40 mt-0.5">
